...
public partial class SkeletonView
{
    public static readonly BindableProperty ContentProperty = BindableProperty.Create(
        ...
        propertyChanged: (b, _, _) => ((SkeletonView)b).OnContentChanged());
    ...
    public static readonly BindableProperty IsBusyProperty = BindableProperty.Create(
        ...
        propertyChanged: (b, _, n) => ((SkeletonView)b).OnIsBusyChanged((bool)n));
    ...
    public static readonly BindableProperty ShimmerEnabledProperty = BindableProperty.Create(
        ...
        propertyChanged: (b, _, _) => ((SkeletonView)b).OnShimmerEnabledChanged());
