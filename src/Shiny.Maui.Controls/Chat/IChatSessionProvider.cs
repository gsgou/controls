...
/// <summary>
/// The integration point a consumer implements to drive a <see cref="ChatView"/>. The control
/// binds to a provider (plus a session id) and renders; all data, lifecycle, permissions and
/// real-time behavior live behind the provider and the <see cref="IChatSession"/> it returns.
/// </summary>
