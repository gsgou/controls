...
public partial class BasicDarkTheme : ResourceDictionary
{
    public BasicDarkTheme()
    {
        ...
        this.Add(ShinyThemeKeys.Color.SurfaceVariant, Color.FromArgb("#3B475B"));
        ...
        this.Add(ShinyThemeKeys.Color.SurfaceContainerHigh, Color.FromArgb("#242B32"));
        this.Add(ShinyThemeKeys.Color.SurfaceContainerHighest, Color.FromArgb("#2F353D"));
        ...
        this.Add(ShinyThemeKeys.Color.InverseOnSurface, Color.FromArgb("#2A3139"));
