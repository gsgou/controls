...
/// <summary>
/// The stroke a highlight draws around its region. Maps to a dash pattern on MAUI and to the CSS
/// keyword of the same name on Blazor.
/// </summary>
public enum DataGridBorderStyle
{
    ...
    /// <summary>Two parallel lines sharing the declared thickness.</summary>
    Double
}
...
/// than declared - see <see cref="DataGridHighlight"/>.
/// </summary>
