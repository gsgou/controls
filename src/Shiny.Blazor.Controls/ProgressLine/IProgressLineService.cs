...
/// <summary>
/// Shows the window-edge <see cref="ProgressLine"/> from code, with no markup on the page and no
/// component parameter to bind. Requires a single <c>&lt;ProgressLineHost /&gt;</c> in the layout.
/// </summary>
/// <remarks>
